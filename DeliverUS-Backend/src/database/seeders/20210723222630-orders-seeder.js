  ...
  up: async (queryInterface, Sequelize) => {
    ...
    */
    await queryInterface.bulkInsert('Orders',
      ...
      // Customer1 id=1
      // pending
        { price: 15.0, address: 'Pending order address', shippingCosts: 0, restaurantId: 1, userId: 1 },
        // terminado 25 min después de comenzado
        { startedAt: new Date(), sentAt: new Date(), deliveredAt: new Date(), price: 19.5, address: 'Delivered order address', shippingCosts: 0, restaurantId: 1, userId: 1 },
        // enviado 15 min después de comenzado
        { startedAt: new Date(), sentAt: new Date(), price: 12.50, address: 'Sent order address', shippingCosts: 0, restaurantId: 1, userId: 1 },
        // en proceso
        { startedAt: new Date(), price: 18.0, address: 'In process order address', shippingCosts: 0, restaurantId: 1, userId: 1 },

        /// /100 montaditos id=2
        // Customer1 id=1
        { startedAt: new Date(), price: 6, address: 'Pending order address', shippingCosts: 1.5, restaurantId: 2, userId: 1 },
        // terminado y entregado 20 minutos después
        { startedAt: new Date(), sentAt: new Date(), deliveredAt: new Date(), price: 10.5, address: 'Delivered order address', shippingCosts: 1.5, restaurantId: 2, userId: 1 }
