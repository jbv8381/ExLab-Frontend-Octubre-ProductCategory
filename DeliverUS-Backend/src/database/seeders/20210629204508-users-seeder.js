    ...
    */
    ...
    await queryInterface.bulkInsert('Users',
      [
        ...
        { firstName: 'Restaurant Owner 2', lastName: 'Fake 2', email: 'owner2@owner.com', password: bcrypt.hashSync('secret', salt), phone: '+3466677888', address: 'Fake street 123', postalCode: '41001', userType: 'owner', avatar: process.env.AVATARS_FOLDER + '/femaleAvatar.png' }
      ], {})
  },
